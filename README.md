...
The `pact/v2` namespace is available in `pact-ruby` v1.67.0, removed in v1.68.0, where it was promoted to `pact` from v2 onwards.
...
- animal service
  - v2 [example/animal-service](../example/animal-service/)
  - v2 [example/zoo-app](../example/zoo-app/)
