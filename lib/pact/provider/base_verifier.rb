    ...
    module Provider
      class BaseVerifier
        ...
        def initialize(pact_config, mixed_config = nil)
          raise ArgumentError, "pact_config must be a subclass of Pact::Provider::PactConfig::Base" unless pact_config.is_a?(::Pact::Provider::PactConfig::Base)
        ...
        def add_provider_transport(pact_handle)
          raise Pact::ImplementationRequired, "Implement #add_provider_transport in a subclass"
        end
