...
require 'pact/provider/rspec_ffi'
  ...
  module Provider
    module Ffi
      class PactSpecRunner
        ...
        include Pact::Provider::RSpec::Ffi::ClassMethods
        ...
        def configure_rspec
          ...
          config.extend Pact::Provider::RSpec::Ffi::ClassMethods
          config.include Pact::Provider::RSpec::Ffi::InstanceMethods
